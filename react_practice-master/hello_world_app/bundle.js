...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    WeatherClocks = __webpack_require__(160),
	...
	var Widgets = React.createClass({
	  ...
	  getInitialState: function () {
	    return { objects: [{ title: "One", content: "test" }, { title: "Two", content: "more testing" }],
	      names: ["Bob", "Steven", "Robert", "Francis", "Ned", "Nerd", "Theon", "Joffrey", "Arya", "Stoneheart"] };
	  },
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(Tabs, { objects: this.state.objects }),
	      React.createElement(WeatherClocks, null)
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  generateHeaders: function () {
	    return this.props.objects.map(function (el, ind) {
	      var classname = "";
	      ...
	      return React.createElement(
	        "li",
	        { className: classname, onClick: this.clicked.bind(this, ind) },
	        el.title
	      );
	    }.bind(this));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    Clocks = __webpack_require__(161),
	    Weathers = __webpack_require__(162);
	
	var WeatherClocks = React.createClass({
	  displayName: 'WeatherClocks',
	
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Clocks, null),
	      React.createElement(Weathers, null)
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weathers = React.createClass({
	  ...
	  weatherQuery: function () {
	    ...
	    var options = {
	      type: "GET",
	      url: "http://api.openweathermap.org/data/2.5/weather?lat=" + this.state.currentLocation.latitude + "&lon=" + this.state.currentLocation.longitude + "&appid=645c5d39c7603f17e23fcaffcea1a3c1",
	      data: "json",
	...
	var AutoComplete = React.createClass({
	  ...
	  generateNames: function () {
	    ...
	    return this.props.names.map(function (el, ind) {
	      ...
	      if (el.slice(0, len) === this.state.value && len !== 0 && !this.state.completed) {
	
	        return React.createElement(
	          'li',
	          { key: ind, onClick: this.completeQuery },
	          ' ',
	          el,
	          ' '
	        );
